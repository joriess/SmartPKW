...
public abstract class RideApiService {
    ...
    public abstract Response findByTimeFrame( @NotNull @Size(min=2,max=2) List<Date> timeframe,SecurityContext securityContext) throws NotFoundException;
    public abstract Response findNearbyRides( @NotNull String address,SecurityContext securityContext) throws NotFoundException;
    ...
    public abstract Response updateRide(RideWithId body,SecurityContext securityContext) throws NotFoundException;
